...
4. Return the most comprehensive and in-depth results
...
[Returns]
- Relevant factual content (directly quotable)
- Core entity insights
- Relationship chain analysis"""

TOOL_DESC_PANORAMA_SEARCH = """\
[Panorama Search - Full Overview]
This tool retrieves a complete overview of simulation results, especially useful for understanding event evolution. It will:
...
This is not LLM simulation — it calls the real interview interface to get agents' original responses.
...
2. Intelligently selects agents most relevant to the interview topic (e.g., analysts, media, officials)
...
[Use Cases]
- Need different role perspectives on events (What do analysts think? What does media say? What's the official stance?)
...
- Each agent's responses on both Twitter and Reddit platforms
...
[Core Concept]
We built a simulated world and injected specific "simulation requirements" as variables. The simulation's evolution results are predictions of what may happen in the future. You are observing not "experimental data" but a "rehearsal of the future."
...
- Agent behavior in the simulated world IS the prediction of future human behavior
...
{
    "title": "Report Title",
    "summary": "Report summary (one sentence capturing core predictive findings)",
    "sections": [
        {
            "title": "Section Title",
...
Note: The sections array must have minimum 2 and maximum 5 elements!"""
...
[Reminder] Report sections: minimum 2, maximum 5. Content should be concise and focus on core predictive findings."""
...
3. [Language consistency]
   - Tool results may contain mixed languages
...
- Section titles are automatically added by the system — just write body text
- Use **bold**, paragraph breaks, quotes, and lists to organize content, but no headings

[Correct Example]
```
This section analyzes the event's opinion propagation dynamics. Through deep analysis of simulation data, we found...

**Initial Breakout Phase**

The info plaza served as the primary channel for breaking news:

> "The info plaza contributed 68% of initial volume..."

**Emotion Amplification Phase**

The community platform further amplified the event's impact:
...
#### 1.1 Detailed Analysis   <- Wrong! No #### sub-divisions
...
- insight_forge: Deep insight analysis, auto-decomposes questions and retrieves facts/relationships from multiple dimensions
...
4. [Quote format - must be standalone paragraphs]
   ...
   > "The response pattern appears rigid and slow in the fast-changing social media environment."
...
[Important Reminders]
1. Carefully read completed sections above — do NOT repeat the same content!
...
- If information is sufficient: output section content starting with "Final Answer:" (must quote the above source material)
...
REACT_TOOL_LIMIT_MSG = (
    ...
    'Please immediately output section content starting with "Final Answer:" based on information gathered.'
)

REACT_UNUSED_TOOLS_HINT = "\nTip: You haven't used: {unused_list} — try different tools for multi-angle information"
