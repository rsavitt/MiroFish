...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are an expert at generating social media user personas. Generate detailed, realistic personas for opinion simulation, faithfully reproducing known real-world situations. You must return valid JSON format. All string values must not contain unescaped newlines. Write in English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, faithfully reproducing known real-world situations.
...
2. persona: Detailed persona description (2000 characters of plain text), must include:
   ...
   - Stances and opinions (attitude toward topics, content that may provoke/move them)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this organization/group entity, faithfully reproducing known real-world situations.
...
2. persona: Detailed account profile description (2000 characters of plain text), must include:
   ...
   - Stances (official position on core topics, approach to handling controversies)
   - Special notes (represented group profile, operational habits)
   - Organizational memory (important part — describe this organization's connection to the event, and their existing actions and reactions in the event)
3. age: Fixed at 30 (virtual age for organizational accounts)
4. gender: Fixed as "other" (organizational accounts use "other" for non-personal)
...
- Organization account communications must match its identity positioning"""
