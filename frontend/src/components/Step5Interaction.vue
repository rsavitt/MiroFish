        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat with the Report Agent. Has 4 specialized tools and full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state using Global/Local Memory for deep causal analysis</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewing — conducts parallel multi-round conversations with simulated agents to collect unstructured viewpoints</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent for deeper report insights' : 'Chat with simulated agents to understand their views' }}
              </p>
            </div>
            <div 
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    // 正确的数据路径: res.data.result.results 是一 agents对象字典
...
/* 修复有序列表编号 - 使用 CSS 计数器让多 agents ol 连续编号 */
.message-text {
